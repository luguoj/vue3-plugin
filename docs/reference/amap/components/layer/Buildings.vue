...
import {PsrAMap, PsrAMapBuildings} from "@psr-framework/vue3-plugin";
import {ref} from "vue";
  ...
  <div style="height: 400px;">
    ...
    >
      <template #default="{map}">
        <psr-a-map-buildings
            :a-map="map"
            :buildings-height-factor="1"
            :buildings-style-opts="styleOpts"
            :layer-zoom-range="[16,20]"
