...
<!--} from "@psr-framework/vue3-plugin";-->
<!--import {ref} from "vue";-->
<!--import * as THREE from "three";-->
<!--import {BoxGeometry} from "three/src/geometries/BoxGeometry";-->
<!--import {GLTFLoader} from "three/examples/jsm/loaders/GLTFLoader";-->

<!--const amapKey = `df81bfae67cdda88febe9dcd006a507d`-->
...
<!--])-->
<!--for (let i = 0; i < 100; i++) {-->
<!--  const element: AMap.MarkerCluster.DataOptions = {weight: 1, lnglat: [117.9749 + Math.random()*0.002 - 0.001, 24.5932 + Math.random()*0.002 - 0.001], title: 'title-' + i};-->
